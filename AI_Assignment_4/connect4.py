...
try:
    ...
    print ("game started in a user friendly interface")
    # for Python3
    from tkinter import *
...
class GUI:
  ...
  def __init__(self):
    ...
    for x,y in self.board.fields:
      tile = Canvas(self.frame, width=60, height=50, bg="white", highlightthickness=0)
  ...
  def update(self):
    for (x,y) in self.board.fields:
      ...
      if (text=='.'):
        self.tiles[x,y].create_oval(10, 5, 50, 45, fill="white", outline="black", width=1)
      if (text=='X'):
        self.tiles[x,y].create_oval(10, 5, 50, 45, fill="green", outline="black", width=1)
      if (text=='O'):
        self.tiles[x,y].create_oval(10, 5, 50, 45, fill="blue", outline="black", width=1)
    for x in range(self.board.width):
